 ...
 */
// require('./bootstrap');
window.Constants = __webpack_require__(/*! ./constants */ "./resources/js/constants.js");

__webpack_require__(/*! ./game/index */ "./resources/js/game/index.js");

__webpack_require__(/*! ./game/assets */ "./resources/js/game/assets.js");

__webpack_require__(/*! ./game/gameinfo */ "./resources/js/game/gameinfo.js");

__webpack_require__(/*! ./game/input */ "./resources/js/game/input.js");

__webpack_require__(/*! ./game/leaderboard */ "./resources/js/game/leaderboard.js");

__webpack_require__(/*! ./game/networking */ "./resources/js/game/networking.js");

__webpack_require__(/*! ./game/render */ "./resources/js/game/render.js");

__webpack_require__(/*! ./game/state */ "./resources/js/game/state.js");
...
var downloadAssets = exports.downloadAssets = function downloadAssets() {
  return downloadPromise;
};

var getAsset = exports.getAsset = function getAsset(assetName) {
  return assets[assetName];
};

/***/ }),

/***/ "./resources/js/game/configs.js":
/*!**************************************!*\
  !*** ./resources/js/game/configs.js ***!
  \**************************************/
/*! no static exports found */
...
var _networking = __webpack_require__(/*! ./networking */ "./resources/js/game/networking.js");

var _render = __webpack_require__(/*! ./render */ "./resources/js/game/render.js");

var _input = __webpack_require__(/*! ./input */ "./resources/js/game/input.js");
...
Promise.all([(0, _networking.connect)(onGameOver), (0, _assets.downloadAssets)()]).then(function () {
  ...
  playButton.onclick = function () {
    ...
    (0, _render.startRendering)();
    (0, _leaderboard.setLeaderboardHidden)(false);
    (0, _gameinfo.setGameinfoHidden)(false);
  };
})["catch"](console.error);
...
function createdForm(params) {
  var form = document.createElement('form');
  form.method = 'POST';
  form.action = "".concat(_configs2["default"].BACKEND_URL, "/game-over");
...
function onGameOver() {
  var me = (0, _render.getInfo)();
  var params = {
    time: Math.floor(me.time),
    kill: me.kill
  };
  var form = createdForm(params);
  if (form) form.submit();
  (0, _input.stopCapturingInput)();
  (0, _render.stopRendering)();
  (0, _leaderboard.setLeaderboardHidden)(true);
  (0, _gameinfo.setGameinfoHidden)(true);
}

/***/ }),

/***/ "./resources/js/game/input.js":
/*!************************************!*\
  !*** ./resources/js/game/input.js ***!
  \************************************/
/*! no static exports found */
...
function handleInput(x, y) {
  var dir = Math.atan2(x - window.innerWidth / 2, window.innerHeight / 2 - y);
  (0, _networking.updateDirection)(dir);
}
...
/***/ "./resources/js/game/leaderboard.js":
/*!******************************************!*\
  !*** ./resources/js/game/leaderboard.js ***!
  \******************************************/
/*! no static exports found */
...
exports.setLeaderboardHidden = setLeaderboardHidden;
...
function updateLeaderboard(data, me) {
  ...
  var maxLeaders = data.length < 10 ? data.length : 10;
  ...
  if (!document.querySelector('.me')) {
    var mePos = data.find(function (obj) {
      return obj.id === me.id;
    });
...
/***/ "./resources/js/game/networking.js":
/*!*****************************************!*\
  !*** ./resources/js/game/networking.js ***!
  \*****************************************/
/*! no static exports found */
...
exports.updateSpeed = exports.pushPlayers = exports.teleport = exports.updateStatus = exports.updateAngle = exports.updateDirection = exports.play = exports.connect = undefined;
...
var connect = exports.connect = function connect(onGameOver) {
  return connectedPromise.then(function () {
    // Register callbacks
...
var updateAngle = exports.updateAngle = (0, _throttleDebounce.throttle)(20, function (angle) {
  socket.emit(Constants.MSG_TYPES.PLAYER_ROTATE, angle);
});
var updateStatus = exports.updateStatus = (0, _throttleDebounce.throttle)(20, function (status) {
  socket.emit(Constants.MSG_TYPES.STATUS_UPDATE, status);
});
var teleport = exports.teleport = (0, _throttleDebounce.throttle)(20, function () {
  socket.emit('teleport');
});
var pushPlayers = exports.pushPlayers = (0, _throttleDebounce.throttle)(20, function () {
  socket.emit('push_players');
});
var updateSpeed = exports.updateSpeed = (0, _throttleDebounce.throttle)(20, function () {
  socket.emit('speed');
});
...
var context = canvas.getContext('2d'); // const canvasSquare = document.getElementById('game-object');
...
function render() {
  var _getCurrentState = (0, _state.getCurrentState)(),
      me = _getCurrentState.me,
      others = _getCurrentState.others;
...
function renderPlayer(me, player) {
  var x = player.x,
      y = player.y;
  var canvasX = canvas.width / 2 + x - me.x;
...
function renderMainMenu() {
  var t = Date.now() / 7500;
  var x = MAP_SIZE / 2 + 800 * Math.cos(t);
  var y = MAP_SIZE / 2 + 800 * Math.sin(t);
  renderBackground(x, y);
}

var renderInterval = setInterval(renderMainMenu, 1000 / 60); // Replaces main menu rendering with game rendering.
...
function getInfo() {
  var _getCurrentState2 = (0, _state.getCurrentState)(),
      me = _getCurrentState2.me;
...
function getCurrentState() {
  ...
  var base = getBaseUpdate();
  var serverTime = currentServerTime(); // If base is the most recent update we have, use its state.
  ...
  if (base < 0 || base === gameUpdates.length - 1) {
    ...
    return {
      ...
      others: interpolateObjectArray(baseUpdate.others, next.others, ratio) // bullets: interpolateObjectArray(baseUpdate.bullets, next.bullets, ratio),
